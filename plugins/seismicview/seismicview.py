...
from plugins.seismicview.subroutine.pyqtEditable import *
...
class MainWindow(QMainWindow):
    def __init__(self, parent = None):
        ...
        self.enginespath = os.path.join(os.getcwd(),'plugins','seismicview', 'engine', 'seismopath')
        file = open(self.enginespath, 'w')
        file.close()

        # design GUI
        self.setWindowTitle('Seismic View (BETA)')
