...
import shutil
import os
import lindu.Widgets.LTomography.LT2D.basic as bs
import lindu.Widgets.LTomography.LT2D.actRay as ray
...
def fwdModel(srcfile,statfile,velfile,evtfile,rayfile,gr,biter,cacah,progress_callback):
...
# srcfile = 'D:/Testing/Anlyze2D/Create Model/src4.src'
# statfile = 'D:/Testing/Anlyze2D/Create MactFwdModel.pyodel/stat4.stat'
# velfile = 'D:/Testing/Anlyze2D/Create Model/vel4.vel2d'
# evtfile = 'D:/Testing/Anlyze2D/fwd/evt4.evt'
# rayfile = 'D:/Testing/Anlyze2D/fwd/ray4.ray2d'
# gr = 100
# biter = 100
# cacah = 20
# main = fwdModel(srcfile,statfile,velfile,evtfile,rayfile,gr,biter,cacah)
